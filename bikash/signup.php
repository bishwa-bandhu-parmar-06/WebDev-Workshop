<?php
	...
	echo'Name of User is : ', $n;
	echo'<br>';


	echo'Mobile of User is : ', $m;
	echo'<br>';
	echo'Email of User is : ', $e;
	echo'<br>';
	echo'Password of User is : ', $p;
	echo'<br>';
...
<div class="menu">
	...
	<label for="fathername">Email : </label><br>
        ...
        <input type="text" placeholder="Password" class="form" id="grandmother" name="p"><br>

        <button value="submit" type="submit" name="signup"> Submit</button><br>
